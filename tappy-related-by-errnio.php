...
define('TAPPY_SEARCHMORE_BY_ERRNIO_VERSION', '2.6');
...
function tappy_searchmore_by_errnio_uninstall() {
	...
	$plugins = tappy_searchmore_by_errnio_multiple_plugins();
...
function tappy_searchmore_by_errnio_load_client_script() {
    ...
    wp_register_script($handle, $script_url, false, TAPPY_SEARCHMORE_BY_ERRNIO_VERSION, true);
...
function tappy_searchmore_by_errnio_multiple_plugins() {
